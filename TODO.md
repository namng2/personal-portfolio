...
- **MapLibre still loads on every phone visit** (~250 KB gzipped) even though
  ...
  hash moved into JS. Opening the Phone window on the Mac now pays that a
...
- **The mirror resumes where it was left.** Closing the Phone window and
  reopening it shows whatever app was last open in the phone, not
